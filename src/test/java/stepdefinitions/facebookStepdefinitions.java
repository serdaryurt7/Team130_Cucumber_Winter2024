...
public class facebookStepdefinitions {
    ...
    public void facebook_cookies_kabul_eder() {
        ...
        // facebookPage.cookiesKabulButonu.click(); // çıkmadığı için bu adım pas geçilmiştir
    }
    ...
    public void faker_class_indan_bilgilerle_facebook_kayit_formunu_doldurur() {
        ...
        actions.sendKeys(faker.name().firstName())
                ...
                .sendKeys(fakeEmail)
                // .sendKeys(Keys.TAB).sendKeys(fakeEmail)  // ikinci kez sormadı
                .sendKeys(Keys.TAB)
    ...
    @Then("faceobok kayit ol tusuna basar")
    public void faceobok_kayit_ol_tusuna_basar() {
